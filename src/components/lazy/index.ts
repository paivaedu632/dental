...
export const LazyFacebookAdCard = React.lazy(() => 
  import('@/components/features/ads/facebook-ad-card').then(module => ({
    default: module.FacebookAdCard
  }))
)
...
export const componentRegistry = {
  ...
  'facebook-ad-card': LazyFacebookAdCard,
} as const
